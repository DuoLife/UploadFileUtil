...
* @version 1.0
*/
package com.dayaoyao.uploadfileutil;
...
import com.dayaoyao.exception.ExceptionMessage;
import com.dayaoyao.exception.MismatchingFileTypeException;
import com.dayaoyao.exception.NULLFileItemException;
import com.dayaoyao.exception.WriteToFileException;

/**
 * <p>Title: Uploadfile.java</p>
 * <p>Description: 请求的参数与上传文件获取的提取工具类</p>
 * <p>Copyright: Copyright (c) 2014</p>
 * @author xuming
 * @date 2014-11-12
...
public class UploadFileUtil {
	...
	private static long MaxSize = 1 * 1024 * 1024;    //4MB
...
//		System.out.println(isMultipart);
	 ...
	 * @date 2014-10-28
	 */
	private List<FileItem> setDiskFactoryAndGetFileItem(HttpServletRequest request, HttpServletResponse response) {
	 ...
	 * @date 2014-10-28
	 */
	private Map processUpload(List<FileItem> items) {
		Map result = new HashMap();
...
//				System.out.println("sizeInBytes:" + sizeInBytes/1024 + "KB");
	...
	private void outStream(HttpServletResponse response, String mesg) {
		try {
			response.setCharacterEncoding("utf-8");
			response.getWriter().print(mesg);
	 ...
	 * @date 2014-10-28
	 */
	private File judgeDirectoryAndCreate(String filePath) {
